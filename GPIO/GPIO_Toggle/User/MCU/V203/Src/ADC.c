...
//    PRINT("adc:%d  %d  %d \r\n",ADCDataDMA[0],ADCDataDMA[1],ADCDataDMA[2]);
    #endif
#endif
}
...
// called right after enable regular conversions are started by software and DMA interrupt happens at end of transfer
...
void ADCInit(void)
{
  ...
  */
  ...
  ADC_InitStruct.ADC_ContinuousConvMode = DISABLE;   //连续模式关闭
